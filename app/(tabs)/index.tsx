  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Image 
          source={{ uri: 'https://images.unsplash.com/photo-1527866512907-a35a62a0f6c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80' }}
      ...
      <View style={styles.infoContainer}>
        <Text style={styles.infoText}>
          Scan products to check if they are made in Europe or by European companies.
          Support local economies and make informed shopping decisions.
        </Text>
      </View>
      ...
      <View style={styles.featuresContainer}>
        ...
        >
          <ShoppingCart size={40} color="#0052B4" />
          <Text style={styles.featureTitle}>Product Database</Text>
          <Text style={styles.featureDescription}>
            Browse our database of products and companies
          </Text>
        </TouchableOpacity>
      ...
      <View style={styles.euContainer}>
        ...
        <Text style={styles.euText}>
          Supporting European products helps strengthen our economy and preserves jobs within the EU.
        </Text>
      </View>
    </ScrollView>
  );
